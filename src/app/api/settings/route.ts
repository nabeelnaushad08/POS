...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const allowed = ["systemName", "logo", "currency", "currencySymbol", "timezone", "taxRate", "theme", "address", "phone", "email", "kotEnabled", "printerIp", "printerEnabled", "slogan", "whatsApp", "receiptNote", "thankYouLine1", "thankYouLine2", "printAgentUrl"];
